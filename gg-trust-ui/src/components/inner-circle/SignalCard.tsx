...
export default function SignalCard({
  ...
  if (state.stage === 'ready') {
    return (
      <div className="ic-card ic-card--ready">
        ...
        {state.note && (
          <p className="ic-card-note">"{state.note}"</p>
        )}
        ...
        <div className="ic-card-actions">
          ...
          <button
            className="ic-btn ic-btn--cancel"
            onClick={() => {
              onChange({ stage: 'draft', note: '', urgency: 'Low' });
              setEvidencePaths(null);
            }}
          >
            Discard
  ...
  return (
    <div className="ic-card ic-card--active">
      ...
      <div className="ic-card-actions">
        {evidencePaths === null ? (
          <button
            className="ic-btn ic-btn--activate"
            onClick={() => {
              const paths = mockWarmPaths[type] ?? [];
        ...
        <button
          className="ic-btn ic-btn--deactivate-text"
          onClick={() => {
            onChange({ stage: 'draft', note: '', urgency: 'Low' });
            setEvidencePaths(null);
          }}
      ...
      <p className="ic-card-quiet">
        {evidencePaths === null
          ? 'Warm paths available (run check)'
          : ''}
      </p>
